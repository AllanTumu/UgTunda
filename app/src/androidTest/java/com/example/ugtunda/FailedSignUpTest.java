...
public class FailedSignUpTest {
    ...
    public void failedSignUpTest() {
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.register_phone_number_input), withText("Phone Number"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.register_phone_number_input),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("0700764974"), closeSoftKeyboard());

        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.register_phone_number_input), withText("0700764974"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
