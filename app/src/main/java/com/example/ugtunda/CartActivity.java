            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    ...
                    if (shippingState.equals("shipped")) {
                        ...
                        txtMsg1.setText("Congratulations, your order has been shipped successfully!!, it will be delivered very soon");
                        NextProcessBtn.setVisibility(View.GONE);

                        Toast.makeText(CartActivity.this, "You can only place one Order at a time", Toast.LENGTH_SHORT).show();
