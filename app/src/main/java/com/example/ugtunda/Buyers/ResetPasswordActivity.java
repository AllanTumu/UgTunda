...
public class ResetPasswordActivity extends AppCompatActivity {
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(ResetPasswordActivity.this, "Answer to security Questions set successfully", Toast.LENGTH_SHORT).show();
    ...
    private void verifyUser() {
        ...
        if (!phone.equals("") && !answer1.equals("") & !answer2.equals("")) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        if (dataSnapshot.hasChild("Security Questions")) {
                            ...
                            if (!ans1.equals(answer1)) {
                                ...
                                newPassword.setHint("Input New password");
            ...
            Toast.makeText(this, "please complete filling in all fields", Toast.LENGTH_SHORT).show();
